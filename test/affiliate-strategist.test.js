...
test('ranks adventure offers by traveler intent and fit', () => {
  const ranked = rankPlacements('Buffalo River kayaking weekend', [
    { key: 'alltrails', category: 'trail', intent: ['hiking'], revenueScore: 4 },
    { key: 'getyourguide', category: 'activity', intent: ['kayaking', 'tour'], revenueScore: 7 },
    { key: 'rei', category: 'gear', intent: ['camping'], revenueScore: 5 }
  ]);
