...
// Internal-link cluster used by destination/adventure templates.
const ozarkroost_internal_link_cluster = [
  { href: '/guides/ozarks-road-trip', label: 'Ozarks road trip ideas' },
  { href: '/guides/trip-planner', label: 'Build an Ozarks trip' },
  { href: '/guides/best-hiking-ozarks', label: 'Ozarks hiking guide' },
  { href: '/guides/ozarks-camping-rv', label: 'Ozarks camping & RV guide' },
  { href: '/guides/best-places-to-stay-ozarks', label: 'Places to stay in the Ozarks' }
];
