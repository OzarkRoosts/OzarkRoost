...
function recordPageview(req, res) {
  ...
  pool.query(
    `INSERT INTO site_traffic_events
     ...
     VALUES ($1, $2, 'pageview', $3, $4, $5, $6, $7)`,
    [String(req.path || req.url || '/').slice(0, 1000), req.method, hashSession(session), referrerHost, visitorType, res.statusCode, visitorType],
...
module.exports = { SESSION_COOKIE, classifyUserAgent, hashSession, shouldTrack, ensureSession, getSession, recordPageview, getSummary };
