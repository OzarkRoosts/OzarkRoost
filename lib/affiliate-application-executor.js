...
async function runCycle() {
  ...
  const { rows } = await pool.query(`SELECT * FROM opsbot_affiliate_applications WHERE status IN ('drafted','queued','retry') ORDER BY created_at ASC LIMIT $1::integer`, [MAX_PER_CYCLE]);
