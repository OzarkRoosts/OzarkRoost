...
const { runFreePromotionSweep } = require('./free-promotion-sweep');
...
async function runFullCampaign() {
  ...
  const jobs = [
    ...
    ['Social', generateSocialPosts], ['Outreach', runOutreachCampaign], ['Free promotion sweep', runFreePromotionSweep],
...
module.exports = { start, runFullCampaign, generateBlogPost, generateSocialPosts, generateSEOContent, generateLandingPage, runFreePromotionSweep };
