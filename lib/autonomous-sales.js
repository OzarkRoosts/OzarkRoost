...
// Use Groq if available (free), otherwise fall back to OpenAI
const _aiKey = process.env.GROQ_API_KEY || process.env.OPENAI_API_KEY;
const _aiBase = process.env.GROQ_API_KEY ? 'https://api.groq.com/openai/v1' : undefined;
const _aiModel = process.env.GROQ_API_KEY
  ? (process.env.GROQ_MODEL || 'llama-3.1-8b-instant')
  : (process.env.OPENAI_MODEL || 'gpt-4o-mini');
const client = new OpenAI({ apiKey: _aiKey, baseURL: _aiBase });
