...
// environment variables. Never invent or ship fake partner IDs.
...
const DEFAULTS = {
  stay22: env('AFF_STAY22_URL', official.stay22), hipcamp: env('AFF_HIPCAMP_URL', official.hipcamp),
  rei: env('AFF_REI_URL', official.rei), getyourguide: env('AFF_GETYOURGUIDE_URL', official.getyourguide),
  outdoorsy: env('AFF_OUTDOORSY_URL', official.outdoorsy), rvshare: env('AFF_RVSHARE_URL', official.rvshare),
  vrbo: env('AFF_VRBO_URL', official.vrbo), booking: env('AFF_BOOKING_URL', official.booking),
  publiclands: env('AFF_PUBLICLANDS_URL', official.publiclands), expedia: env('AFF_EXPEDIA_URL', official.expedia),
  hotels: env('AFF_HOTELS_URL', official.hotels), kayak: env('AFF_KAYAK_URL', official.kayak),
  tripadvisor: env('AFF_TRIPADVISOR_URL', official.tripadvisor), klook: env('AFF_KLOOK_URL', official.klook),
...
const LABELS = {
  ...
  getyourguide: 'Book tours on GetYourGuide', outdoorsy: 'Rent an RV on Outdoorsy', rvshare: 'Find RVs on RVshare',
  vrbo: 'Browse Vrbo cabins', booking: 'Search Booking.com', publiclands: 'Outfit at Public Lands',
  expedia: 'Compare hotels on Expedia', hotels: 'Search Hotels.com', kayak: 'Compare stays on Kayak',
  tripadvisor: 'Read reviews on Tripadvisor', klook: 'Browse activities on Klook', alltrails: 'Map trails on AllTrails',
  amazon_camping: 'Camping essentials on Amazon', amazon_kayak: 'Kayaks & paddles on Amazon', amazon_binoculars: 'Travel binoculars on Amazon',
  airbnb: 'Browse Airbnb Ozarks homes', recreation: 'Reserve on Recreation.gov', list_cabin: 'List your business on OzarkRoost', operators: 'Partner with OzarkRoost',
};

const BLURBS = {
  stay22: 'Compare bookable stays near your Ozarks route.', hipcamp: 'Unique land stays, glamping sites, and private campgrounds.',
  rei: 'Camping, hiking, fishing, and river gear.', getyourguide: 'Book guided tours and activities for your trip.',
  outdoorsy: 'RV and camper rentals for Arkansas road trips.', rvshare: 'Peer-to-peer RV rentals near the Ozarks.',
  vrbo: 'Whole-home cabin rentals and vacation homes.', booking: 'Search lodging inventory across Arkansas.',
  publiclands: 'Camping and trail gear for public-land weekends.', expedia: 'Compare hotels and stays when you need options.',
  hotels: 'Find lodging near lakes, towns, and attractions.', kayak: 'Compare travel prices in one search.',
  tripadvisor: 'Traveler reviews and photos before you book.', klook: 'Tickets and activities for your itinerary.',
  alltrails: 'Trail maps for Ozarks hikes and adventures.', amazon_camping: 'Camp kitchen, lights, and packing-list staples.',
  amazon_kayak: 'Portable boats and paddling gear.', amazon_binoculars: 'Compact glass for wildlife and overlooks.',
  airbnb: 'Unique homes and host-run stays.', recreation: 'Official camping and recreation reservations.',
  list_cabin: 'Get discovered by travelers planning Ozarks trips.', operators: 'Put your tourism business in front of Ozarks travelers.',
};
...
// Only paid listing records should be presented as customer listings. Do not seed fake businesses into this display helper.
