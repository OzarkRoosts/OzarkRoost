...
const official = {
  ...
  viator: `https://www.viator.com/searchResults/all?text=Ozarks%20Arkansas`,
...
const DEFAULTS = {
  ...
  viator: env('AFF_VIATOR_URL', official.viator),
...
const LABELS = {
  ...
  getyourguide: 'Book tours on GetYourGuide', viator: 'Book experiences on Viator', outdoorsy: 'Rent an RV on Outdoorsy',
...
const BLURBS = {
  ...
  viator: 'Rated Ozarks tours, cave tickets, and adventure day trips.', outdoorsy: 'Delivery-ready RVs and camper vans for Arkansas trips.', rvshare: 'Peer-to-peer RVs near the Ozarks.',
...
const BUNDLES = {
  ...
  monetize_all: ['stay22','hipcamp','vrbo','booking','airbnb','expedia','hotels','kayak','getyourguide','viator','klook','outdoorsy','rvshare','recreation','rei','publiclands','alltrails','tripadvisor','amazon_camping'],
};
...
function getFeaturedListings() { return [
  { name: 'Mystic Caverns', location: 'Berryville, AR', type: 'Attraction', blurb: 'Living cave tours minutes from Eureka Springs.', href: '/out?to=' + encodeURIComponent(DEFAULTS.viator) },
